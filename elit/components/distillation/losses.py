...
def kd_mse_loss(logits_S, logits_T, temperature=1):
    ...
    Args:
      logits_S: Tensor of shape (batch_size, length, num_labels) or (batch_size, num_labels)
      logits_T: Tensor of shape (batch_size, length, num_labels) or (batch_size, num_labels)
      temperature: A float or a tensor of shape (batch_size, length) or (batch_size,) (Default value = 1)
...
def att_mse_loss(attention_S, attention_T, mask=None):
    ...
    Args:
      torch: Tensor logits_S: tensor of shape  (*batch_size*, *num_heads*, *length*, *length*)
      torch: Tensor logits_T: tensor of shape  (*batch_size*, *num_heads*, *length*, *length*)
      torch: Tensor mask: tensor of shape  (*batch_size*, *length*)
      attention_S: 
      attention_T: 
...
def att_mse_sum_loss(attention_S, attention_T, mask=None):
    ...
    * If the `inputs_mask` is given, masks the positions where ``input_mask==0``.
    ...
    Args:
      torch: Tensor logits_S: tensor of shape  (*batch_size*, *num_heads*, *length*, *length*) or (*batch_size*, *length*, *length*)
      torch: Tensor logits_T: tensor of shape  (*batch_size*, *num_heads*, *length*, *length*) or (*batch_size*, *length*, *length*)
      torch: Tensor mask:     tensor of shape  (*batch_size*, *length*)
      attention_S: 
      attention_T: 
      mask:  (Default value = None)
...
def hid_mse_loss(state_S, state_T, mask=None):
    ...
    * If the hidden sizes of student and teacher are different, 'proj' option is required in `inetermediate_matches` to match the dimensions.
    ...
    Args:
      torch: Tensor state_S: tensor of shape  (*batch_size*, *length*, *hidden_size*)
      torch: Tensor state_T: tensor of shape  (*batch_size*, *length*, *hidden_size*)
      torch: Tensor mask:    tensor of shape  (*batch_size*, *length*)
      state_S: 
      state_T: 
      mask:  (Default value = None)
...
def pkd_loss(state_S, state_T, mask=None):
    ...
    * If the hidden sizes of student and teacher are different, 'proj' option is required in `inetermediate_matches` to match the dimensions.
    ...
    Args:
      torch: Tensor state_S: tensor of shape  (*batch_size*, *length*, *hidden_size*)
      torch: Tensor state_T: tensor of shape  (*batch_size*, *length*, *hidden_size*)
      mask: not used. (Default value = None)
      state_S: 
      state_T: 
...
def fsp_loss(state_S, state_T, mask=None):
    ...
    * If the hidden sizes of student and teacher are different, 'proj' option is required in `inetermediate_matches` to match the dimensions.
    ...
    Args:
      torch: tensor state_S: list of two tensors, each tensor is of the shape  (*batch_size*, *length*, *hidden_size*)
      torch: tensor state_T: list of two tensors, each tensor is of the shape  (*batch_size*, *length*, *hidden_size*)
      torch: tensor mask:    tensor of the shape  (*batch_size*, *length*)
