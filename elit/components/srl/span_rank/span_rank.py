...
from elit.components.srl.span_rank.inference_utils import srl_decode
from elit.components.srl.span_rank.span_ranking_srl_model import SpanRankingSRLModel
from elit.components.srl.span_rank.srl_eval_utils import compute_srl_f1
from elit.datasets.srl.conll2012 import CoNLL2012SRLDataset, filter_v_args, unpack_srl, \
    group_pa_by_p
...
class SpanRankingSemanticRoleLabeler(TorchComponent):
    def __init__(self, **kwargs) -> None:
        ...
        (:cite:`he-etal-2018-jointly`). It generates candidate triples of (predicate, arg_start, arg_end) and rank them.
