...
from elit.datasets.ner.json_ner import unpack_ner
...
class BiaffineNamedEntityRecognition(Task, BiaffineNamedEntityRecognizer):
    ...
    def compute_kd_loss(self, batch: Dict[str, Any],
        ...
        logits_s = output_student['candidate_ner_scores']
        logits_t = output_teacher['candidate_ner_scores']
        return kd_loss_function(logits_s, logits_t, temperature_function(logits_s, logits_t))
