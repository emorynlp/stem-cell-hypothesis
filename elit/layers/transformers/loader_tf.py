...
from elit.layers.transformers.tf_imports import zh_albert_models_google, bert_models_google
from elit.utils.io_util import get_resource, stdout_redirected, elit_home
    ...
    if transformer in zh_albert_models_google:
        ...
        with stdout_redirected(to=os.devnull):
            model_url = fetch_tfhub_albert_model(transformer,
                                                 os.path.join(elit_home(), 'thirdparty', 'tfhub.dev', 'google',
                                                              transformer))
        albert = True
