...
def split_long_sentence_into(tokens: Iterable[str], max_seq_length, sent_delimiter=None, char_level=False,
...
def hash_batch_tokens(batch: dict):
    """Calculate the hash of a batch based on its tokens.
