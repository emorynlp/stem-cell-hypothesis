...
from elit.datasets.srl.ontonotes5.english import ONTONOTES5_POS_ENGLISH_TRAIN, ONTONOTES5_POS_ENGLISH_TEST, \
    ...
    ONTONOTES5_NER_ENGLISH_DEV, ONTONOTES5_SRL_ENGLISH_TRAIN, ONTONOTES5_SRL_ENGLISH_TEST, ONTONOTES5_SRL_ENGLISH_DEV
...
def main():
    ...
    save_dir = f'data/model/mtl/ontonotes_bert_base_en/joint_gated/all/random/3'
