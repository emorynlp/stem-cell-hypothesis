...
def main():
    ...
    # save_dir = 'data/model/mtl/ontonotes_albert_base_en/lw/ner_srl/2'
    # save_dir = 'data/model/mtl/ontonotes_albert_base_en/lw/ner_dep/0'
    save_dir = 'data/model/mtl/ontonotes_bert_base_en/basic/ner/0'
    folder = 'static'
    # folder = 'single'
    # folder = 'pairwise-ner'
