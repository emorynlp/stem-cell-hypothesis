...
if not static:
    ...
    save_dir = f'data/model/mtl/ontonotes_bert_base_en_/srl/0/static/records.pt'
...
if static:
    plt.savefig('data/model/mtl/ontonotes_bert_base_en_/srl/0/static/srl-acc-per-layer.pdf')
else:
    plt.savefig('data/model/mtl/ontonotes_bert_base_en_/srl/0/single/srl-acc-per-layer.pdf')
plt.show()
