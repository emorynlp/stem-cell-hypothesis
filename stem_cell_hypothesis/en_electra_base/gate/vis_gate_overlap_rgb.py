...
# cache_path = 'data/research/mtl/electra/dep-gates.pt'
# cache_path = 'data/research/mtl/electra/ner-gates.pt'
# cache_path = 'data/research/mtl/electra/con-gates.pt'
# cache_path = 'data/research/mtl/electra/srl-gates.pt'
cache_path = 'data/research/mtl/electra/pos-gates.pt'
# cache_path = 'data/research/mtl/electra/joint-gates.pt'

os.makedirs(os.path.dirname(cache_path), exist_ok=True)

gates = []
for i in range(3):
    # path = f'data/model/mtl/ontonotes_electra_base_en/gate/all/{i}'
    # path = f'data/model/mtl/ontonotes_electra_base_en/gated/pos/finetune/encoder1e-5_{i}'
    # path = f'data/model/mtl/ontonotes_electra_base_en/single/gated/dep/coef0.01_epochs30/{i}'
    # path = f'data/model/mtl/ontonotes_electra_base_en/single/gated/ner/{i}'
    # path = f'data/model/mtl/ontonotes_electra_base_en/single/gate/con/{i}'
    # path = f'data/model/mtl/ontonotes_electra_base_en/single/gated/srl/{i}'
    path = f'data/model/mtl/ontonotes_electra_base_en/single/gated/pos/{i}'
