...
from elit.components.mtl.gated.finetune_gated_mtl import FineTuneMultiTaskLearning
...
def main():
    ...
    mtl = FineTuneMultiTaskLearning()
    save_dir = f'data/model/mtl/ontonotes_electra_base_en/joint_gated/pos_dep/finetune/stage_nogatelr'
    ...
    mtl.fit(
        ...
        # cache='data/tmp',
        # debug=True,
        finetune='data/model/mtl/ontonotes_electra_base_en/joint_gated/pos_dep/finetune/noreg_overlap0.01'
    )
