...
if not static:
    ...
    save_dir = f'data/model/mtl/ontonotes_electra_base_en/single/no-gate/dep/{0}/static/records.pt'
...
if static:
    plt.savefig('data/research/mtl/electra/dep-acc-per-layer.pdf')
else:
    plt.savefig('data/model/mtl/ontonotes_electra_base_en/dep/0/single/dep-acc-per-layer.pdf')
plt.show()
