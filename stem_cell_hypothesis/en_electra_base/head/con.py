...
def main():
    cdroot()
    # save_dir = f'data/model/mtl/ontonotes_electra_base_en/single/no-gate/con/2'
    # save_dir = 'data/model/mtl/ontonotes_electra_base_en/con/0'
    # folder = 'single'
    # folder = 'static'
    # save_dir = f'data/model/mtl/ontonotes_electra_base_en/mtl/no-gate/srl_con/0'
    save_dir = f'data/model/mtl/ontonotes_electra_base_en/mtl/no-gate/all/0'
    folder = 'joint-con'
