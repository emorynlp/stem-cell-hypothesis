...
from elit.datasets.srl.ontonotes5.chinese import ONTONOTES5_POS_CHINESE_TRAIN, ONTONOTES5_POS_CHINESE_TEST, \
    ...
    ONTONOTES5_DEP_CHINESE_DEV, ONTONOTES5_DEP_CHINESE_TRAIN, ONTONOTES5_SRL_CHINESE_TRAIN, ONTONOTES5_SRL_CHINESE_DEV, \
    ONTONOTES5_SRL_CHINESE_TEST, ONTONOTES5_NER_CHINESE_TEST, ONTONOTES5_NER_CHINESE_DEV, ONTONOTES5_NER_CHINESE_TRAIN
...
def main():
    ...
    tasks = {
        ...
        'ner': BiaffineNamedEntityRecognition(
            ONTONOTES5_NER_CHINESE_TRAIN,
            ONTONOTES5_NER_CHINESE_DEV,
            ONTONOTES5_NER_CHINESE_TEST,
            SortingSamplerBuilder(batch_size=64, batch_max_tokens=6400),
            lr=1e-3,
            doc_level_offset=True,
        ),
        'srl': SpanRankingSemanticRoleLabeling(
            ONTONOTES5_SRL_CHINESE_TRAIN,
            ONTONOTES5_SRL_CHINESE_DEV,
            ONTONOTES5_SRL_CHINESE_TEST,
            SortingSamplerBuilder(batch_size=64, batch_max_tokens=6400),
            lr=1e-3,
            doc_level_offset=True,
        ),
    ...
    save_dir = 'data/model/mtl/ontonotes_albert_base_zh/selfteaching10_new_3'
    ...
    mtl.fit(
        ...
        cache='data/tmp',
        self_teaching=SelfTeaching(after_epochs=10, loss_weighted_sum=False, cache_prefix='data/tmp'),
        prefetch=1,
        # debug=True,
    )
