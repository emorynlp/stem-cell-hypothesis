...
from elit.datasets.srl.ontonotes5.english import ONTONOTES5_POS_ENGLISH_TRAIN, ONTONOTES5_POS_ENGLISH_TEST, \
    ...
    ONTONOTES5_DEP_ENGLISH_DEV, ONTONOTES5_DEP_ENGLISH_TRAIN, ONTONOTES5_NER_ENGLISH_TEST, ONTONOTES5_NER_ENGLISH_DEV, \
...
def main():
    ...
    for i in range(0, 3):
        ...
        save_dir = f'data/model/mtl/ontonotes_deberta_base_en/gated/ner/finetune/{i + 3}'
        ...
        #     # cache='data/tmp',
        #     # debug=True,
        #     concrete_coef=0.0002,
        #     patience=1.0,
        #     # finetune='data/model/mtl/ontonotes_deberta_base_en/ner/2'
        #     # seed=1613840374,
        # )
