...
# cache_path = 'data/research/mtl/deberta/dep-gates.pt'
# cache_path = 'data/research/mtl/deberta/ner-gates.pt'
# cache_path = 'data/research/mtl/deberta/con-gates.pt'
# cache_path = 'data/research/mtl/deberta/srl-gates.pt'
# cache_path = 'data/research/mtl/deberta/pos-gates.pt'
cache_path = 'data/research/mtl/deberta/joint-gates.pt'

os.makedirs(os.path.dirname(cache_path), exist_ok=True)

gates = []
for i in range(3):
    path = f'data/model/mtl/ontonotes_deberta_base_en/joint_gated/{i}'
    # path = f'data/model/mtl/ontonotes_deberta_base_en/gated/pos/finetune/encoder1e-5_{i}'
    # path = f'data/model/mtl/ontonotes_deberta_base_en/gated/dep/coef0.02_epochs30/{i}'
    # path = f'data/model/mtl/ontonotes_deberta_base_en/gated/ner/finetune/{i + 3}'
    # path = f'data/model/mtl/ontonotes_deberta_base_en/gated/con/{i}'
    # path = f'data/model/mtl/ontonotes_deberta_base_en/gated/srl/{i}'
