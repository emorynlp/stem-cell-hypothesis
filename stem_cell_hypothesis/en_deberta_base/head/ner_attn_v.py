...
def main():
    ...
    # save_dir = 'data/model/mtl/ontonotes_deberta_base_en/pairwise/ner_srl/2'
    # save_dir = 'data/model/mtl/ontonotes_deberta_base_en/lw/ner_dep/0'
    # save_dir = 'data/model/mtl/ontonotes_deberta_base_en/basic/ner/2'
    # folder = 'static'
    # folder = 'single'
    folder = 'joint-ner'
