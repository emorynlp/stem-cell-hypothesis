...
from elit.datasets.srl.ontonotes5.chinese import ONTONOTES5_POS_CHINESE_TRAIN, ONTONOTES5_POS_CHINESE_TEST, \
    ...
    ONTONOTES5_DEP_CHINESE_DEV, ONTONOTES5_DEP_CHINESE_TRAIN, ONTONOTES5_NER_CHINESE_TEST, ONTONOTES5_NER_CHINESE_DEV, \
...
def main():
    ...
    for i in range(3):
        ...
        save_dir = f'data/model/mtl/ontonotes_bert_base_zh/single/ner/{i}'
