...
def main():
    ...
    save_dir = f'data/model/mtl/ontonotes_roberta_base_en/joint_gated/pos_dep/finetune/debug'
    ...
    mtl.fit(
        ...
        # cache='data/tmp',
        debug=True,
        finetune='data/model/mtl/ontonotes_roberta_base_en/joint_gated/pos_dep/finetune/noreg_overlap0.1'
    )
