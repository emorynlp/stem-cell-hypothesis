...
for tag in rs[0].label_correct:
    tag: str = tag
    if tag in ('.', ',', 'UH', 'HYPH', 'POS', 'CC', 'CD', 'DT', 'MD', 'PDT', 'PRP', 'TO', 'PRP$'):
        continue
...
if static:
    plt.savefig('data/model/mtl/ontonotes_roberta_base_en/pos/basic/0/static/speciality.pdf')
else:
    plt.savefig('data/model/mtl/ontonotes_roberta_base_en/pos/basic/0/single/speciality.pdf')
plt.show()
