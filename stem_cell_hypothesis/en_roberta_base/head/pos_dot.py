...
if not static:
    ...
    save_dir = f'data/model/mtl/ontonotes_roberta_base_en/pos/basic/0/static/records.pt'
...
if static:
    plt.savefig('data/model/mtl/ontonotes_roberta_base_en/pos/basic/0/static/pos-acc-per-layer.pdf')
else:
    plt.savefig('data/model/mtl/ontonotes_roberta_base_en_/pos/0/single/pos-acc-per-layer.pdf')
plt.show()
