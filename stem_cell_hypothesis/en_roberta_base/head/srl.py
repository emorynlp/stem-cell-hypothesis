...
def main():
    cdroot()
    # save_dir = f'data/model/mtl/ontonotes_roberta_base_en/single/no-gate/srl/2'
    # save_dir = 'data/model/mtl/ontonotes_roberta_base_en_/srl/2'
    # save_dir = f'data/model/mtl/ontonotes_roberta_base_en/mtl/no-gate/srl_con/2'
