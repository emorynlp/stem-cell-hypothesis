...
def main():
    cdroot()
    # save_dir = f'data/model/mtl/ontonotes_roberta_base_en/single/no-gate/con/0'
    # save_dir = 'data/model/mtl/ontonotes_roberta_base_en/con/0'
    # folder = 'single'
    # folder = 'static'
    # save_dir = f'data/model/mtl/ontonotes_roberta_base_en/mtl/no-gate/srl_con/0'
    save_dir = f'data/model/mtl/ontonotes_roberta_base_en/mtl/no-gate/all/2'
    folder = 'joint-con'
...
def calc_acc(save_dir, folder):
    ...
    # save_dir = f'data/model/mtl/ontonotes_roberta_base_en/dep/0'
    ...
    for batch, attentions in cache:
        if records is None:
            ...
            records = ConAcc()
        attn_values = torch.stack(attentions, dim=2).to(device)  # B, T, L, H, C
