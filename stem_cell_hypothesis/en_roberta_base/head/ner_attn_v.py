...
def main():
    cdroot()
    # save_dir = 'data/model/mtl/ontonotes_roberta_base_en/all/lw/3'
    # save_dir = 'data/model/mtl/ontonotes_roberta_base_en/lw/ner_srl/2'
    # save_dir = 'data/model/mtl/ontonotes_roberta_base_en/lw/ner_dep/0'
    # save_dir = 'data/model/mtl/ontonotes_roberta_base_en/mtl/no-gate/ner_srl/0'
    save_dir = f'data/model/mtl/ontonotes_roberta_base_en/mtl/no-gate/all/0'
    # folder = 'static'
    # folder = 'single'
    folder = 'joint-ner'
