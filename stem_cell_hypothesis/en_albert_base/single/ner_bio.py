...
from elit.datasets.srl.ontonotes5.english import ONTONOTES5_POS_ENGLISH_TRAIN, ONTONOTES5_POS_ENGLISH_TEST, \
    ...
    ONTONOTES5_DEP_ENGLISH_DEV, ONTONOTES5_DEP_ENGLISH_TRAIN, ONTONOTES5_NER_ENGLISH_TSV_TRAIN, ONTONOTES5_NER_ENGLISH_TSV_DEV, \
    ONTONOTES5_NER_ENGLISH_TSV_TEST
    ...
    for i in range(3):
        tasks = {
            ...
            'ner': TaggingNamedEntityRecognition(
                ONTONOTES5_NER_ENGLISH_TSV_TRAIN,
                ONTONOTES5_NER_ENGLISH_TSV_DEV,
                ONTONOTES5_NER_ENGLISH_TSV_TEST,
        ...
        save_dir = f'data/model/mtl/ontonotes_albert_base_ner_bio_en_{i}'
